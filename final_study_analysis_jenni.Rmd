...
# lives with others
d2$lives_with_others[d2$lives_with_others == "No"] <- 0
d2$lives_with_others[d2$lives_with_others == "Yes"] <- 1
...
# covariate balance
bal.tab(treatment_seq ~ gender_code + age_range_code + lives_with_others_code + know_us + location_lat + location_long, 
        data = d2)
```
