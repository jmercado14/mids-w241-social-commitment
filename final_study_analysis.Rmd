...
bal.tab(treatment_seq ~ factor(gender) + factor(age_range) + factor(lives_with_others) + factor(know_us) + location_lat + location_long, 
        data = d2)
cov_check <- lm(treatment_seq ~ factor(gender) + factor(age_range) + factor(lives_with_others) + factor(know_us) + location_lat + location_long, 
                data = d2)
summary(cov_check)
```
