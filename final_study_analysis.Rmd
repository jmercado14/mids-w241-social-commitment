...
names(d2) <- c("user_id", "treatment_seq", "location_lat", "location_long", "name", "email", "gender", "age_range", "location", "lives_with_others", "submitted_response", "noncompliance_ind", "know_us",
