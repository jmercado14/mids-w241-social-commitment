...
## For control vs digital vs in person ##
```{r}
fit_3 <- lm(outcome ~ treatment + userId, d)
# robust se
se_3 <- sqrt(diag(vcovHC(fit_3, type = 'HC')))

fit_3_covariates <- lm(outcome ~ treatment + userId + age_range + gender + lives_with_others + know_us + location_lat + location_long, d)
# robust se
